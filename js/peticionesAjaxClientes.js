...
function consultar_todo(){
    $.ajax({
        url:"https://gb646640033fbfd-bdreto1.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/client/client",
		type:"GET",
        datatype:"json",
...
function consultaID(id){
	...
	if(!validarCampo($("#id"))){
		...
		$.ajax({
			url: 'https://gb646640033fbfd-bdreto1.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/client/client'+ id.val(),			
			type: 'GET',
			dataType: 'json',
